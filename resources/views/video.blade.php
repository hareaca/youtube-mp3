<div class="video">
	...
	<div class="details">
		...
		<div>
			...
			?>
			<a href="{!! route('download', [$URLID, 't' => $__t_, 'tv' => $__tv_]) !!}" class="download" downloading-html="<i class='fa fa-save'></i> downloading <span class='jumping-dots'><span>.</span><span>.</span><span>.</span></span>"
				 t="{!! $__t_ !!}"
				 tv="{!! $__tv_ !!}">
